...
function storeWin(rod, score){
    ...
    resetBoard(rod);
    alert(rod + " wins the game with a score of " + (score * 100) + ". The maximum score in this game is " + (maxScore*100) + ".");
}
window.addEventListener('keypress', function(){
    let rodSpeed = 20;
    let rodRect = rod1.getBoundingClientRect();
    if (this.event.code === 'KeyD' && ((rodRect.x+rodRect.width) < this.window.innerWidth)){
